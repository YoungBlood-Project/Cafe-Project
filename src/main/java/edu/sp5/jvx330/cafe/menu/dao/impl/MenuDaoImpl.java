...
public class MenuDaoImpl implements MenuDao {
	...
	public void addMenu(Menu menu) {
		String sql = "INSERT INTO Menu(menuName, menuPrice, category)"
				+ " VALUES(?,?,?)";
		//System.out.println(menu);
		jdbcTemplate.update(sql, menu.getMenuName(), 
				menu.getMenuPrice(), menu.getCategory());
	}
	...
	public Long findMidByMenu(String menuName) {
		//메뉴 이름은 중복되지 않는다는 가정
		String sql =  "SELECT mid, menuName, menuPrice, category"
	...
	public List<Menu> findAllMenus() {
		String sql = "SELECT mid, menuName, menuPrice, category FROM Menu";
